...
def Move_Servos(a1, a2, a3, a4):
	...
	print('a = {0}, b = {1},c = {2}, d = {3}'.format(a1,a2,a3,a4))
	...
	if a4!=d:
		...
		d = a4
	end_time = time.time()
	print("Time to move servos = {0}".format(end_time - start_time))
...
def set_servo_angles(x_distance, y_distance):
	...
	#	print('rotate servo 2')
		d = flat_d
		b = get_rotation_angle_servo(2, x_distance)
	elif x_distance < -3:
	#	print('rotate servo 4')
		d = get_rotation_angle_servo(4, -1*x_distance)
		b = flat_b
	else:
		d = flat_b
		b = flat_d
	...
	#	print('rotate servo 3')
		c = get_rotation_angle_servo(3, y_distance) # positive
		a = flat_a
	elif y_distance < -3:
		print('rotate servo 1')
		a = get_rotation_angle_servo(1, -1*y_distance)
		c = flat_c
	else:
		a = flat_a
		c = flat_c	
...
#	clientThread = ClientThread(name="ClientThread", clientSocket = clientSocket)
	while True:
		try:
			...
			end_time = time.time()
			print("Time difference = {0}".format(end_time- start_time))
			#clientThread.start()
