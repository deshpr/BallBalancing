	...
	while True:
		try:			
			...
			if platform_center!=None and object_center!=None:				
				...
				print('x = {0}, y = {0}'.format(object_center[0]-platform_center[0],object_center[1]-platform_center[1]))
				set_servo_angles(object_cm[0]-platform_cm[0], object_cm[1]-platform_cm[1])
				print('Now rotating the servos...')
				print('In main, a = {0}, b = {1},c = {2}, d = {3}'.format(a,b,c,d))
				MoveServos(a,b,c,d)
				#MoveServos()
